...
public class UsuarioDAO {
	...
	public UsuarioBEAN autenticarUsuario (UsuarioBEAN user) {
	...
	public boolean cadastrarUsuario(UsuarioBEAN user) {
		this.conexao = this.conexaobd.getConnection();
		
		EnderecoDAO dao = new EnderecoDAO();
		int idEndereco = dao.cadastrarEndereco(user.getEndereco());
		...
		if (idEndereco != 0) {
			try {
				...
				PS.setInt   (8, user.getCargo().getId());
